...
public class Consts {
	public static final int time_granularity = 0; //60; // time granularity for location updates (in seconds)
	public static final int time_diff = 5;         // time difference between two GPS readings for direction calculation
	public static final int dist_granularity = 0; //2;  // distance granularity for location updates (in metres)
